  ...
  return (
    <button
      ...
      className={`
        ...
        overflow-hidden rounded-xl border p-3 transition-all duration-150 bg-white
        ${
          isTaken
            ? 'border-zinc-300 shadow-xs hover:border-black hover:shadow-md'
            : 'border-zinc-200 shadow-xs hover:border-black hover:shadow-md'
        }
    ...
    >
      ...
      <div className="flex w-full flex-1 items-center justify-center py-1 transition-all duration-150 group-hover:opacity-10">
      ...
      {/* Bottom Price Bar */}
      <div className="flex w-full items-center justify-between text-[11px] font-mono transition-all duration-150 group-hover:opacity-10">
      ...
      {/* Hover Action Overlay (Clean Light Glassmorphic with High-Contrast Button) */}
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center opacity-0 transition-opacity duration-150 group-hover:opacity-100 bg-white/80 backdrop-blur-[2px]">
        <span
          className={`rounded-lg px-4 py-1.5 text-xs font-bold font-mono tracking-wider shadow-md transition-transform group-hover:scale-105 ${
            isTaken
